<div class="sidebar-menu" style="font-family: system-ui;font-size:14px;">
    ...
    <ul id="main-menu" class="">
            ...
            <ul>
                ...
                ?>
                    <li class="<?php if ($page_name == 'subject' && $class_id == $row['class_id']) echo 'active'; ?>">
                        <a style='font-weight:550;font-size:14px' href="<?php echo base_url(); ?>admin/subject/<?php echo $row['class_id']; ?>">
        ...
        <li class="<?php if ($page_name == 'class_routine') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>admin/class_routine" style='font-weight:550;font-size:14px'>
        ...
        <li class="<?php if ($page_name == 'parent') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>admin/parent" style='font-weight:550;font-size:14px'>
        ...
        <li class="<?php if ($page_name == 'manage_attendance') echo 'active'; ?> ">
            <a style='font-weight:550;font-size:14px' href="<?php echo base_url(); ?>admin/manage_attendance/<?php echo date("d/m/Y"); ?>">
