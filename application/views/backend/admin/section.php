<hr />
<a style="margin-right:15px; color: #ffffff; font-size: 14px; font-family: system-ui;" href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>modal/popup/section_add/');" class="btn btn-primary pull-right">
