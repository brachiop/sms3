<div class="row">
	...
	<div class="col-md-12 col-sm-12 clearfix">
		<h3 style="margin-bottom:0px; margin-top:0px;font-weight: 500; color:#ffa800; font-family: system-ui;"><?php echo "Bienvenu," ?> <?php echo  $this->session->userdata('name'); ?></h3>
		...
		<ul class="list-inline links-list pull-right" style="margin-bottom:0px; margin-top:0px;">
			<!-- Logout Button -->
			<li>
				<a href="<?php echo base_url(); ?>login/logout" style="font-weight: 400; font-size:15px;color:#008055;">
					Déconnexion
