...
class Admin extends CI_Controller
{
    ...
    function student_add()
    {
        ...
        $page_data['page_title'] = 'Ajout Étudiant';
        $this->load->view('backend/index', $page_data);
    }
    function student_information($class_id = '')
    {
        ...
        $page_data['page_title']     = 'Information Étudiant' . " : " .
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gérer Enseignants';
        $this->load->view('backend/index', $page_data);
    }
    /****MANAGE SUBJECTS*****/
    function subject($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gérer Enseignements';
        $this->load->view('backend/index', $page_data);
    }
    /****MANAGE CLASSES*****/
    function classes($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = 'Gérer Niveaux';
        $this->load->view('backend/index', $page_data);
    }
    /****MANAGE SECTIONS*****/
    function section($class_id = '')
    {
        ...
        $page_data['page_title'] = 'Gérer Sections';
        $page_data['class_id']   = $class_id;
        $this->load->view('backend/index', $page_data);
    }
    ...
    function exam($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gérer Examens';
        $this->load->view('backend/index', $page_data);
    }
    /****MANAGE EXAM MARKS*****/
    function marks($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        $page_data['page_title'] = 'Gestion Notes';
        $this->load->view('backend/index', $page_data);
    }
    /****MANAGE GRADES*****/
    function grade($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = 'Gérer Résultat';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gérer EDT';
        $this->load->view('backend/index', $page_data);
    }
    /****** DAILY ATTENDANCE *****************/
    function manage_attendance($date = '', $month = '', $year = '', $class_id = '')
    {
        ...
        $page_data['page_title'] =    'Gerer Absences';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = 'Gestion Annonces';
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $this->db->update('settings', $data);
            $this->session->set_flashdata('flash_success', 'Système mis à jour avec succès!');
        ...
        if ($param1 == 'change_skin') {
            ...
            $this->db->update('settings', $data);
            $this->session->set_flashdata('flash_success', 'Thème mis à jour!');
            redirect(base_url() . 'admin/system_settings/', 'refresh');
        }
